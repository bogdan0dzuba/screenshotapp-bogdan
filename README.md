...
Нажмите заметную кнопку «Снимок с прокруткой» в нижней панели, выберите область и подтвердите её крупной кнопкой «Начать» в панели над рамкой. Рядом сразу видны «Отмена» и `Esc - отмена`. Затем прокручивайте страницу небольшими шагами в одном направлении и останавливайтесь минимум на 0,5 секунды. Уже снятый объём остаётся виден голубым следом-стикером даже за пределами выбранной рамки: при прокрутке вниз след растёт под нижней границей, при прокрутке вверх - над верхней. Новый участок сохраняется только после остановки, а перекрывающиеся кадры склеиваются в один длинный снимок.
...
4. Для длинной страницы нажмите «Снимок с прокруткой», выделите область и нажмите «Начать» в панели над рамкой. Дождитесь сообщения о готовности, прокручивайте примерно на треть области только в одном направлении и останавливайтесь минимум на 0,5 секунды. Стабильная голубая отметка показывает сохранённый viewport, внешний голубой след остаётся на экране за рамкой, а оранжевое состояние просит вернуть перекрытие. Панель с крупными командами и подсказкой `Esc - отмена` не исчезает при возврате в браузер.
