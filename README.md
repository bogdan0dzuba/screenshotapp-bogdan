...
Нажмите заметную кнопку «Снимок с прокруткой» в нижней панели, выберите область и подтвердите её крупной кнопкой «Начать» в панели над рамкой. Рядом сразу видны «Отмена» и `Esc - отмена`. Затем прокручивайте страницу небольшими шагами в одном направлении и останавливайтесь минимум на 0,5 секунды. Сбоку от рамки появляется узкая панель, в которой растёт **настоящая склейка**: видно ровно то, что уйдёт в итоговый PNG, а не абстрактный объём прокрутки. Под превью - подпись состояния: «Жду прокрутки», «Догоняю», «Кадр принят», «Верните перекрытие». Кнопка «Крутить само» отдаёт прокрутку приложению: оно двигает страницу шагом в треть области и останавливается, когда страница кончилась. Для неё нужен «Универсальный доступ»; при отказе остаётся обычная ручная прокрутка.
...
4. Для длинной страницы нажмите «Снимок с прокруткой», выделите область и нажмите «Начать» в панели над рамкой. Дальше либо нажмите «Крутить само», либо прокручивайте вручную примерно на треть области в одном направлении, останавливаясь минимум на 0,5 секунды. Панель сбоку показывает растущую склейку и состояние; за пределами рамки ничего не рисуется, поэтому страница остаётся читаемой. Панель с крупными командами и подсказкой `Esc - отмена` не исчезает при возврате в браузер.
