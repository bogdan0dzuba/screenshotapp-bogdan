...
Нажмите заметную кнопку «Снимок с прокруткой» в нижней панели, выберите область и подтвердите её крупной кнопкой «Начать» в панели над рамкой. Рядом сразу видны «Отмена» и `Esc - отмена`. Затем прокручивайте страницу небольшими шагами в одном направлении и останавливайтесь минимум на 0,5 секунды. Уже снятый объём остаётся виден голубым следом-стикером даже за пределами выбранной рамки, новый участок сохраняется только после остановки, а перекрывающиеся кадры склеиваются в один длинный снимок.
